...
########################################################
    ...
    def ajouter(self):
        ...
        try:
            ...
            versement = float(versement)
            reste = montant_total - versement
        except ValueError:
            mb.showerror('Erreur', 'Veuillez saisir des montants valides pour le Versement', parent=self.master)
            return    
        else:
    ...
    def imprimer_informations_patient(self, patient_id):
        ...
        try:
            ...
            if patient_info:
                ...
                Âge : {patient_info[3]}
                Motif : {patient_info[4]}
                Jour : {patient_info[5]}
                Rendez-vous : {patient_info[6]}
                Montant total : {patient_info[7]}
                Versement : {patient_info[8]}
                Reste : {patient_info[9]}
                Téléphone : {patient_info[10]}
                """
